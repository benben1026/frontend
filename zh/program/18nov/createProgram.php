...
<body>   
  ...
  <script type="text/javascript">
    $("#next_stepfour").click(function(){
      ...
      $.post(
      "http://128.199.174.170/telesport/index.php/program/createProgram",
      {
          type:1,
          name:programName,
      ...
      function(data){
        ...
        if(programId<0){
          ...
          $.post(
          "http://128.199.174.170/telesport/index.php/program/updatePricePlan",
          {
              type:2,
              programId:programId,
              price:price
          ...
          function(data){
            ...
            //programId =2;
            window.location='http://128.199.174.170/version0.2/zh/program/createTemplate.php?programId='+programId;
         }
